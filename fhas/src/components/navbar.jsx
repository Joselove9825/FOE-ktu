  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center p-4">
        {/* Brand */}
        <Link href="/faculty/index.html" className="text-2xl font-bold text-indigo-600 hover:text-indigo-700">
        ...
        <nav className="hidden md:flex space-x-6 text-gray-700 font-medium items-center">
          <Link href="/faculty/index.html" className="hover:text-indigo-600 transition">Home</Link>
          ...
          <Link href="/faculty/about.html" className="hover:text-indigo-600 transition">About Us</Link>
          <Link href="/faculty/research.html" className="hover:text-indigo-600 transition">Research</Link>
          <Link href="/faculty/news.html" className="hover:text-indigo-600 transition">News</Link>
          <Link href="/faculty/programmes.html" className="hover:text-indigo-600 transition">Programmes</Link>
          <Link href="/faculty/admissions.html" className="hover:text-indigo-600 transition">Admissions</Link>
          <Link href="/faculty/student-life.html" className="hover:text-indigo-600 transition">Student Life</Link>
          <Link href="/faculty/contact.html" className="hover:text-indigo-600 transition">Contact Us</Link>
          <Link href="/faculty/staff-directory.html" className="hover:text-indigo-600 transition">Staff Directory</Link>
          <Link href="/faculty/facilities.html" className="hover:text-indigo-600 transition">Facilities</Link>
          <Link href="/faculty/alumni.html" className="hover:text-indigo-600 transition">Alumni</Link>
        </nav>
      </div>
      ...
      {mobileMenuOpen && (
        <nav id="mobile-menu" className="md:hidden bg-white border-t border-gray-200 shadow-lg">
          <div className="flex flex-col space-y-1 py-4 px-6 text-gray-700 font-medium">
            <Link href="/faculty/index.html" className="block hover:text-indigo-600 transition py-2">Home</Link>
            ...
            <Link href="/faculty/about.html" className="hover:text-indigo-600 transition py-2">About Us</Link>
            <Link href="/faculty/research.html" className="hover:text-indigo-600 transition py-2">Research</Link>
            <Link href="/faculty/news.html" className="hover:text-indigo-600 transition py-2">News</Link>
            <Link href="/faculty/programmes.html" className="hover:text-indigo-600 transition py-2">Programmes</Link>
            <Link href="/faculty/admissions.html" className="hover:text-indigo-600 transition py-2">Admissions</Link>
            <Link href="/faculty/student-life.html" className="hover:text-indigo-600 transition py-2">Student Life</Link>
            <Link href="/faculty/contact.html" className="hover:text-indigo-600 transition py-2">Contact Us</Link>
            <Link href="/faculty/staff-directory.html" className="hover:text-indigo-600 transition py-2">Staff Directory</Link>
            <Link href="/faculty/facilities.html" className="hover:text-indigo-600 transition py-2">Facilities</Link>
            <Link href="/faculty/alumni.html" className="hover:text-indigo-600 transition py-2">Alumni</Link>
          </div>
        </nav>
      )}
    </header>
